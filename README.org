...
#+BEGIN_QUOTE
*ATENÇÃO:* Esse repositório foi escriot usando o *Org Mode* do Emacs, você poderá
encontrar algumas incongruências de formatação. Recomendamos fortemente que, caso
tenha interesse em ler de forma mais detalhada, use Emacs ou visualize na forma "raw".
#+END_QUOTE
